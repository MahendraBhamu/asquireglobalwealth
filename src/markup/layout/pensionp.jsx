...
class Pensionp extends Component {
  render() {
    return (
      <>
                  ...
                  <aside class="sidebar">
                    ...
                    <div class="sidebar-widget-two categories-widget-two">
                      <div class="widget-content">
                        <ul>
                        <li>
                            <NavLink activeClassName='active' to={"/uaepensiontransfer"}>
                              UAE Pension Scheme {" "}
                          ...
                          <li>
                            <NavLink activeClassName='active' to={"/ukpensiontransfer"}>
                              UK Pension Transfer {" "}
                              <i class="fa fa-angle-right"></i>
                            </NavLink>
                          </li>
                          <li>
                            <NavLink activeClassName='active' to={"/australiansuperannuation"}>
                            Australian Superannuation <i class="fa fa-angle-right"></i>
                            </NavLink>
                          </li>
