                            ...
                            <div class="inner">
                                ...
                                <div class="top-right">
                                    ...
                                    <ul class="clearfix social-links">
                                        <li><a href ="https://www.linkedin.com/company/asquire-global-wealth/"><span class="fab fa-linkedin"></span></a></li>                                       <li><Link to={'/#'}><span class="fab fa-facebook-square"></span></Link></li>
...
.main-header.header-style-two .main-menu .navigation>li>a{\
      ...
      "}</style>
                    ...
                    <div class="auto-container clearfix" style={{backgroundColor:'#350cc7'}}>

                        <div class="logo pull-left">
                            <Link to={'/#'} title=""><img src={require('../../assets/images/Asquire.png')} alt="" title="" /></Link>
                        </div>
